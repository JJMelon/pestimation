    ...
    def parse(self, model, origin_datetime="2017 Jun 1 2:00PM"):
        ...
        for name, obj in self.all_gld_objects.items():
            ...
            if obj_type == "node" or obj_type == "meter":
                ...
                impedance_matrix, impedance_matrix_exists = try_load_direct_line_impedance(config)
                if not impedance_matrix_exists:
                ...
                api_line.impedance_matrix_exists = impedance_matrix_exists

                capacitance_matrix, capacitance_matrix_exists = try_load_direct_line_capacitance(config)

                if not capacitance_matrix_exists:
                ...
                api_line.capacitance_matrix_exists = capacitance_matrix_exists
