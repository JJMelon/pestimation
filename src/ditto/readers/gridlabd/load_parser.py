    ...
    def __parse_phase_load(self, model, obj, all_schedules, phase, is_delta):
        ...
        try:
            try:
                ...
                phaseload.p = p*phaseload.ppercentpower
                phaseload.q = np.sqrt(p**2 - phaseload.p**2)
                phaseload.use_zip = 1
                yield phaseload
                ...
                #    phaseload.qpercentcurrent = current_fraction * (1 - current_pf)
                #except ValueError:
                #    current_fraction = 0
                #    current_pf = 0
                #    phaseload.ppercentcurrent = 0 
                #    phaseload.qpercentcurrent = 0
                #try:
                #    impedance_fraction = float(obj[f"impedance_fraction_{phase}"])
                #    impedance_pf = float(obj[f"impedance_pf_{phase}"])
                #    phaseload.ppercentimpedance = (impedance_fraction * impedance_pf)
                #    phaseload.qpercentimpedance = impedance_fraction * (1 - impedance_pf)
                #except ValueError:
                #    impedance_fraction = 0
                #    impedance_pf = 0
                #    phaseload.ppercentimpedance = 0
                #    phaseload.qpercentimpedance = 0
